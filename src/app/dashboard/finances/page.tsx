...
export default function FinancesPage() {
  ...
  useEffect(() => {
    ...
    const refreshFinances = () => {
      const cashierSnapshot = readCashierState<BookingRecord>("lighthouse-cashier-transactions", "lighthouse-cashier-seq", 1);
      const kitchenSnapshot = readPosState<unknown, PosPaymentRecord, unknown>(activeKitchenKey, "lighthouse-kitchen-tickets", "lighthouse-kitchen-seq", "lighthouse-kitchen-payments", "lighthouse-kitchen-menu", 1);
      const baristaSnapshot = readPosState<unknown, PosPaymentRecord, unknown>(activeBaristaKey, "lighthouse-barista-orders", "lighthouse-barista-seq", "lighthouse-barista-payments", "lighthouse-barista-menu", 1);
    ...
    const unsubscribers = [
      subscribeToSyncedStorageKey("lighthouse-cashier-state", refreshFinances),
