...
export default function RoomsPage() {
  ...
  useEffect(() => {
    ...
    const unsubscribeRooms = subscribeToSyncedStorageKey<Room[]>("lighthouse-rooms-state", (value) => {
  ...
  const getStatusTextStyles = (status: Room["status"]) => {
    switch (status) {
      ...
      case "cleaning":
        return "bg-amber-500 text-white border-amber-500 hover:bg-amber-500";
      case "maintenance":
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 gap-3 md:grid-cols-4 md:gap-4">
        ...
        <Card className="bg-amber-50/50 border-amber-100 shadow-none">
          <CardContent className="flex items-center gap-3 p-3 md:gap-4 md:p-4">
            <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-amber-500 text-white shadow-lg shadow-amber-500/20 md:h-10 md:w-10">
              <Clock className="h-5 w-5 md:h-6 md:w-6" />
            </div>
            <div className="min-w-0">
              <p className="text-[10px] font-black uppercase leading-4 tracking-wider text-amber-700">Cleaning</p>
          ...
          <div className="flex flex-col gap-3">
            <Tabs value={typeFilter} onValueChange={(value) => setTypeFilter(value as TypeFilter)}>
              <TabsList className="h-10">
                ...
                <TabsTrigger value="Luxury" className="text-[10px] font-black uppercase tracking-widest">Luxury</TabsTrigger>
                <TabsTrigger value="Classic" className="text-[10px] font-black uppercase tracking-widest">Classic</TabsTrigger>
              </TabsList>
            </Tabs>
