...
export const BARISTA_INVENTORY_SEED: BarStockSeedItem[] = [
  ...
  stock("coca-cola-bottle", "Coca-Cola Bottle", "", 29, 1000, 579.166666666667, "Soft Drinks"),
  ...
  stock("kilimanjaro-water-15l", "Kilimanjaro Water", "1.5 L", 27, 2000, 783.33, "Water / Juice"),
